...
/**
 * Walker that passes through Blockers instead of turning around
 */
public class RebelWalker extends Walker 
{
  /**
   ...
   */
	public RebelWalker(Pingu p)
	{
		super(p);
	}
	
	@Override
	public boolean collidesWithBlocker(Level lev)
	{
		return false;
	}
	...
	{
		return new RebelWalkerFaller(this);
	}
}
