...
/**
 * Walker that becomes an invincible faller whenever it falls
 */
public class InvincibleFallerWalker extends Walker 
{
  /**
   ...
   */
	public InvincibleFallerWalker(Pingu p)
	{
		super(p);
	}
	...
	{
		return new InvincibleFaller(this);
	}
